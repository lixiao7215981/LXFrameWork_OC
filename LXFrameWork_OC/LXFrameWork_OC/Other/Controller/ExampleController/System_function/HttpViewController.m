...
//        [HttpTool HttpToolPostWithUrl:@"http://hzd.skyware.com.cn/api/Newestversion" paramesers:@{@"1":@{@"100":@"里边的1",@"101":@"里边的2"},@"2":@[@"1",@"2",@"3",@"4",@"5"],@"3":@"好痛好痛",@"4":@"好痛好痛",@"5":@"好痛好痛",@"6":@"好痛好痛",@"7":@"好痛好痛",@"8":@"好痛好痛",@"9":@"好痛好痛",@"10":@"好痛好痛"} requestHeaderField:@{@"1":@"好痛好痛",@"2":@"好痛好痛",@"3":@"好痛好痛",@"4":@"好痛好痛",@"5":@"好痛好痛",@"6":@"好痛好痛",@"7":@"好痛好痛",@"8":@"好痛好痛",@"9":@"好痛好痛",@"10":@"好痛好痛"} Serializer:JSONResponseSerializer Success:^(id json) {
//            NSLog(@"成功---%@",json);
//        } failure:^(NSError *error) {
//            NSLog(@"失败---%@",error);
//        }];
